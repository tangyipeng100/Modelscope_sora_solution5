...
class Tag2Text_Caption(nn.Module):
    def __init__(self,                 
        ...
        self.vision_multi = BertModel.from_pretrained('vbench_models/huggingface/hub/models--bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594/',config=q2l_config, add_pooling_layer=False)
...
def init_tokenizer():
    tokenizer = BertTokenizer.from_pretrained('vbench_models/huggingface/hub/models--bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594/')
